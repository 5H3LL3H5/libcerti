...
throw (rti1516e::InvalidLogicalTime)
{
    if (this != &value)
    {
        ...
        if (other == NULL)
        {
            ...
            //throw rti1516e::InvalidLogicalTime(L"Different LogicalTime implementation");
#else
            //throw rti1516e::InvalidLogicalTime(L"Different LogicalTime implementation");
#endif
        } else
...
#else
        return 0;
        //throw rti1516e::CouldNotEncode(L"Not enough space in buffer to encode RTI1516fedTime");
#endif
    }
}
...
#else
        //throw rti1516e::CouldNotEncode(L"Not enough space in buffer to decode RTI1516fedTime");
#endif
    }
        }
...
#else
        //throw rti1516e::CouldNotEncode(L"Not enough space in buffer to encode RTI1516fedTimeInterval");
#endif
    }
    return false;
}
...
void
RTI1516fedTimeInterval::decode(rti1516e::VariableLengthData const & encodedValue)
...
#else
        //throw rti1516e::CouldNotEncode(L"Not enough space in buffer to decode RTI1516fedTimeInterval");
#endif
    }
}
